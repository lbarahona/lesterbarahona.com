...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php esc_html_e('Skip to content', 'lester-developer'); ?></a>
    ...
    <header id="masthead" class="site-header">
        <div class="header-inner">
            ...
            <button class="menu-toggle" aria-controls="header-nav" aria-expanded="false">
                <span class="screen-reader-text"><?php esc_html_e('Menu', 'lester-developer'); ?></span>
            ...
            <div id="header-nav" class="header-nav-group">
                ...
                <div class="header-actions">
                    <div class="header-social-links">
                        ...
                        <a href="https://www.linkedin.com/in/lester-barahona" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
