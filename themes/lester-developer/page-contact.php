 ...
 *
 * Form submission is handled via AJAX (see mu-plugins/contact-form-ajax.php)
 * to bypass Cloudflare APO caching issues with POST requests.
 *
            ...
            <div class="contact-grid">
                <div class="contact-info">
                    ...
                    <div class="contact-card">
                        ...
                        <div class="contact-card__content">
                            <h3>GitHub</h3>
                            <p>Check out my open source work and contributions</p>
                            <a href="https://github.com/lbarahona" target="_blank" rel="noopener noreferrer" class="contact-card__link">
                                github.com/lbarahona
                            </a>
                        </div>
                    </div>
                ...
                <div class="contact-form-wrapper">
                    <div class="contact-form-card">
                        ...
                        <form class="contact-form" action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="contact-form">
